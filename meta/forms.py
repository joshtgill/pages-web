...
class ApproveOrganizationForm(forms.Form):
    organizationIdToApprove = forms.IntegerField()


class DenyOrganizationForm(forms.Form):
    organizationIdToDeny = forms.IntegerField()
